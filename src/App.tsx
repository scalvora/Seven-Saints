...
// ✅ FIX 1: Logo must be in /public folder. Use a simple clean path.
const LOGO_SRC = '/logo.png';

// ✅ FIX 2: Add fallback handling for all external images
// Using direct Unsplash/Pexels URLs with specific dimensions for reliability
...
const DESERT_SLIDESHOW_IMAGES = [
  'https://images.pexels.com/photos/5717775/pexels-photo-5717775.jpeg?auto=compress&cs=tinysrgb&w=1920',
...
// ============================================================
// ✅ FIX 3: Robust Image Component with Error Handling
// ============================================================
  ...
  if (hasError) {
    ...
    return (
      <div
        ...
        style={{
          ...style,
          background: 'linear-gradient(135deg, #2A2218 0%, #3D3428 50%, #2A2218 100%)',
          minHeight: '200px',
        }}
      >
        <div className="text-center p-4">
          <div className="text-gold/30 text-4xl mb-2">✦</div>
          <p className="font-montserrat text-cream/20 text-[10px] tracking-[2px] uppercase">
            {alt}
          </p>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <img
        src={src}
        alt={alt}
        className={`${className} ${isLoaded ? '' : 'sr-only'}`}
        style={style}
        loading={loading}
...
// ============================================================
// ✅ FIX 4: Logo component with text fallback
// ============================================================
...
function Logo({
  ...
  if (logoFailed) {
    return (
      <div className={`flex items-center justify-center ${className}`} style={style}>
        <span
          className="font-cormorant text-gold tracking-[6px] uppercase"
  ...
  return (
    <img
      src={LOGO_SRC}
      alt="The Seven Saints"
      className={`mx-auto object-contain ${className}`}
      style={{ filter: 'brightness(1.2) sepia(0.2)', ...style }}
...
function RevealImage({
  ...
  return (
    <div
      ref={ref}
      className={`${cls} ${isInView ? 'revealed' : ''} ${className} overflow-hidden group img-warm-hover`}
      style={{ transitionDelay: `${delay}ms` }}
    >
...
function GoldLine({
  ...
  return (
    <div
      className="h-[1px] bg-gradient-to-r from-transparent via-gold to-transparent mx-auto transition-all ease-out"
      style={{
  ...
  return (
    <div ref={ref} className="py-4">
      <div className="elegant-separator">
        <div
          className="line line-reverse"
          style={{ width: isInView ? '50px' : '0px' }}
        />
        <div
          className="moroccan-star"
          style={{
...
function DesertBackground({
  ...
  return (
    <div
      ...
      style={{ opacity }}
    >
      {/* Layer 0: Animated desert gradient (always visible) */}
      <div className="absolute inset-0 desert-gradient-animated" />

      {/* Layer 0.5: Dune silhouette shapes */}
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="dune-shape-1 absolute bottom-0 left-0 right-0 h-[45%]"
          style={{
            background:
              'linear-gradient(to top, rgba(90, 62, 36, 0.5) 0%, rgba(139, 105, 20, 0.2) 40%, transparent 100%)',
            clipPath:
              'polygon(0% 100%, 0% 55%, 8% 48%, 18% 42%, 30% 38%, 42% 35%, 52% 33%, 60% 32%, 68% 33%, 78% 36%, 88% 40%, 95% 45%, 100% 50%, 100% 100%)',
          }}
        />
        <div
          className="dune-shape-2 absolute bottom-0 left-0 right-0 h-[35%]"
          style={{
            background:
              'linear-gradient(to top, rgba(26, 23, 20, 0.6) 0%, rgba(90, 62, 36, 0.3) 50%, transparent 100%)',
            clipPath:
              'polygon(0% 100%, 0% 65%, 5% 58%, 15% 50%, 25% 45%, 38% 42%, 50% 40%, 62% 38%, 72% 40%, 82% 44%, 90% 50%, 96% 58%, 100% 65%, 100% 100%)',
          }}
        />
      </div>
        ...
        {DESERT_SLIDESHOW_IMAGES.map((src, i) => (
          ...
          >
            <SafeImage
              ...
              style={{
                filter: 'saturate(0.7) brightness(0.6) sepia(0.3) contrast(1.1)',
              }}
            />
          </div>
        ))}
      ...
      <div
        className="absolute inset-0 bg-gradient-to-t from-[#1A1714] via-[#1A1714]/30 to-transparent"
        style={{ opacity: overlayOpacity }}
      />
      <div
        className="absolute inset-0 bg-gradient-to-b from-[#1A1714]/50 via-transparent to-transparent"
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-[1]">
      {rays.map((r, i) => (
        <div
          key={i}
          className="absolute top-0 h-full light-ray"
          style={
            {
              right: r.right,
              width: `${r.width}px`,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 50% 65%, rgba(196, 120, 91, 0.08) 0%, rgba(201, 169, 110, 0.04) 30%, transparent 60%)',
          opacity: phase >= 3 ? 1 : 0,
      ...
      <div
        className="absolute left-0 right-0 top-[58%] h-[2px] horizon-glow"
        style={{
          background:
            'linear-gradient(90deg, transparent 10%, rgba(201, 169, 110, 0.15) 30%, rgba(196, 120, 91, 0.2) 50%, rgba(201, 169, 110, 0.15) 70%, transparent 90%)',
      ...
      <div className="relative z-10 text-center">
        <p
          className="font-montserrat text-[9px] sm:text-[10px] tracking-[6px] uppercase mb-8"
          style={{
        ...
        <div
          style={{
            ...
            transition:
              'all 1.6s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
          }}
        >
          <Logo className="h-14 sm:h-18 md:h-20 mb-4" />
          <h1
            className={`font-cormorant text-xl sm:text-2xl md:text-3xl tracking-[10px] sm:tracking-[12px] uppercase gold-glow ${phase >= 3 ? 'shimmer-gold' : 'text-gold'}`}
        ...
        <div
          ...
          style={{
            ...
            background:
              'linear-gradient(90deg, transparent, rgba(196,120,91,0.5), #C9A96E, rgba(196,120,91,0.5), transparent)',
            transition:
        ...
        <p
          className="font-montserrat text-[9px] sm:text-[10px] tracking-[5px] uppercase mt-7"
          style={{
  ...
  return (
    <>
      <div
        ...
        style={{
          width: hovering ? '44px' : '12px',
          height: hovering ? '44px' : '12px',
          left: pos.x,
          top: pos.y,
          ...
          transition:
            'width 0.35s ease, height 0.35s ease, background-color 0.35s ease, border 0.35s ease',
        }}
      />
      <div
  ...
  return (
    <div
      ...
      style={{
        width: `${progress * 100}%`,
        background:
          'linear-gradient(90deg, #C4785B, #C9A96E, #E0C88A, #C9A96E)',
    ...
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-14 flex items-center justify-between h-18 sm:h-20 lg:h-24">
          ...
          <button
            ...
            className="md:hidden text-cream/80 p-2 hover:text-gold transition-colors"
            aria-label="Menu"
          >
            <svg
              width="22"
      ...
      >
        ...
        <button
          ...
          className="absolute top-5 right-5 text-cream/60 p-3 hover:text-gold transition-colors"
          aria-label="Close"
        >
          <svg
            width="24"
        ...
        <div className="flex flex-col items-center gap-9">
          <Logo className="h-12 mb-4 opacity-60" />
...
function HeroSection({ loaded }: { loaded: boolean }) {
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div
        className="ambient-glow bottom-[15%] right-[5%]"
        style={{ animationDelay: '7s', opacity: 0.08 }}
      />
      ...
      <div
        className="absolute bottom-[25%] left-0 right-0 h-[20%] pointer-events-none horizon-glow"
        style={{
          background:
            'radial-gradient(ellipse at 50% 50%, rgba(196, 120, 91, 0.06), transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        <div
          style={{
            ...
            transition:
              'all 1.4s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
            transitionDelay: '100ms',
          }}
        >
          <Logo
            className="h-16 sm:h-20 md:h-24 mb-5"
            style={{
              filter:
                'brightness(1.3) drop-shadow(0 0 30px rgba(201,169,110,0.2))',
            }}
          />
        </div>
        ...
        <div
          className="h-[1px] mx-auto mt-6 md:mt-8"
          style={{
            width: loaded ? '100px' : '0px',
            background:
              'linear-gradient(90deg, transparent, rgba(196,120,91,0.5), #C9A96E, #E0C88A, #C9A96E, rgba(196,120,91,0.5), transparent)',
            transition:
        ...
        <p
          className="font-montserrat font-light text-cream/75 text-[10px] sm:text-[12px] md:text-[13px] tracking-[4px] sm:tracking-[6px] uppercase mt-5 md:mt-7"
          style={{
            opacity: loaded ? 1 : 0,
      ...
      <div
        className="absolute bottom-8 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center animate-scroll-bounce"
        style={{
          opacity: loaded ? 1 : 0,
      ...
      >
        <p className="font-montserrat text-[8px] tracking-[4px] uppercase text-cream/25 mb-3">
          Scroll
        </p>
      ...
      <div ref={ref} className="max-w-[660px] mx-auto px-6 text-center">
        ...
        <FadeUp delay={400}>
          <p className="font-montserrat font-light text-brown text-[14px] sm:text-[15px] leading-[2] mb-10">
            ...
            heritage. Here, the Atlas Mountains frame every horizon, and the
            rhythm of the desert replaces the pace of the world you left
            behind.
          </p>
        </FadeUp>
        <FadeUp delay={600}>
...
function ExperienceSection() {
  ...
  return (
    <section
      id="experience"
      className="relative bg-charcoal py-20 sm:py-28 lg:py-40 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 sm:gap-5 lg:gap-6">
          <div className="md:col-span-7">
            <RevealImage
              src={IMAGES.tentInterior}
              alt="Luxury tented suite interior"
              aspect="aspect-[16/10]"
              direction="left"
            />
          ...
          <div className="md:col-span-5 flex flex-col justify-end">
            <RevealImage
              src={IMAGES.pool}
              alt="Infinity pool with Atlas Mountains"
              aspect="aspect-[3/4]"
              direction="right"
              delay={200}
            />
          ...
          <div className="md:col-span-5">
            <RevealImage
              src={IMAGES.camels}
              alt="Camel silhouettes at golden hour"
              aspect="aspect-[3/4]"
              direction="left"
              delay={100}
            />
          ...
          <div className="md:col-span-7 flex flex-col justify-start">
            <RevealImage
              src={IMAGES.candleDinner}
              alt="Candlelit dinner under the stars"
              aspect="aspect-[16/10]"
              direction="right"
              delay={250}
            />
          ...
          <div className="md:col-span-12">
            <RevealImage
              src={IMAGES.desertPanorama}
              alt="Sand dune patterns at golden hour"
              aspect="aspect-[21/8]"
              direction="up"
              delay={150}
            />
...
function SuitesSection() {
  return (
    <section
      id="suites"
      className="relative bg-cream py-20 sm:py-28 lg:py-40 warm-border-top"
    >
  ...
  return (
    <section id="dining" ref={sectionRef} className="relative">
      <div className="relative h-[65vh] sm:h-[75vh] overflow-hidden">
        <div
          className="absolute inset-0 animate-ken-burns-out parallax-container"
          style={{ transform: `translateY(${parallaxY}px)` }}
        >
          <SafeImage
            src={IMAGES.diningHero}
            alt="Outdoor desert dining"
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
          <FadeUp>
            <p className="font-montserrat text-[9px] tracking-[5px] uppercase text-gold-muted/50 mb-5">
              CHAPTER THREE
            </p>
          </FadeUp>
          <FadeUp delay={200}>
            <h2
              className="font-cormorant text-cream text-[30px] sm:text-[40px] md:text-[52px] tracking-[4px] uppercase gold-glow"
          ...
          <FadeUp delay={400}>
            <div
              className="h-[1px] w-16 mx-auto mt-6"
              style={{
                background:
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <FadeUp>
            <p className="font-montserrat font-light text-brown text-center text-[14px] sm:text-[15px] leading-[2] max-w-[580px] mx-auto mb-12 sm:mb-16">
              Moroccan heritage meets artisan craft. Every plate tells a story
              of the land &mdash; saffron from Taliouine, olive oil from the
              Atlas foothills, bread baked in earth ovens at dawn.
            </p>
          </FadeUp>
          <RevealImage
            src={IMAGES.guestDining}
            alt="Atmospheric desert dining"
            aspect="aspect-[21/9]"
            direction="up"
          />
        </div>
...
function StorySection() {
  return (
    <section
      id="story"
      className="relative bg-charcoal-light moroccan-pattern py-20 sm:py-28 lg:py-40 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-[700px] mx-auto px-6 text-center">
        <FadeUp>
          <p className="font-montserrat text-[9px] tracking-[5px] uppercase text-gold-muted/50 mb-3">
            CHAPTER FOUR
          </p>
          <p className="font-montserrat text-[10px] sm:text-[11px] tracking-[4px] uppercase text-gold-muted mb-7">
            OUR STORY
          </p>
        </FadeUp>
        ...
        <FadeUp delay={400}>
          <p className="font-montserrat font-light text-cream/80 text-[14px] sm:text-[15px] leading-[2.1] mb-8">
            For centuries, the city of Marrakech has been watched over by its
            seven patron saints &mdash; the Sab&#39;atou Rijal. These seven
            holy men, mystics and scholars, arrived from across the Islamic
            world and chose this red city as their home, their sanctuary, their
            final resting place.
          </p>
        </FadeUp>
        ...
        <FadeUp delay={600}>
          <p className="font-montserrat font-light text-cream/80 text-[14px] sm:text-[15px] leading-[2.1] mb-8">
            ...
            spiritual foundation of a city that has enchanted travelers for a
            thousand years. To invoke the seven saints is to invoke protection,
            wisdom, and the grace of the desert.
          </p>
        </FadeUp>

        <FadeUp delay={800}>
          <p className="font-montserrat font-light text-cream/80 text-[14px] sm:text-[15px] leading-[2.1] mb-12">
            The Seven Saints Agafay carries this legacy into the desert &mdash;
            a place where every guest is received not as a visitor, but as a
            pilgrim. Where hospitality is not a service, but a sacred act.
            Where the land itself holds memory, and the silence speaks of
            centuries.
          </p>
        </FadeUp>
      ...
      <div className="mt-16 sm:mt-24 lg:mt-32">
        <RevealImage
          src={IMAGES.campTwilight}
          alt="Desert dunes at twilight"
          aspect="aspect-[21/8] sm:aspect-[3/1]"
          direction="up"
    ...
    <section className="relative bg-cream py-20 sm:py-28 lg:py-36 section-glow-top">
      <div className="max-w-[780px] mx-auto px-6 text-center">
        ...
        <div className="mt-16 sm:mt-24">
          <FadeUp>
            <p className="font-montserrat text-[9px] sm:text-[10px] tracking-[4px] uppercase text-gold-muted/40 mb-8">
              AS FEATURED IN
            </p>
          </FadeUp>
          <FadeUp delay={200}>
            <div className="flex items-center justify-center gap-6 sm:gap-12 flex-wrap">
              {[
                ...
                <span
                  key={name}
                  className="font-cormorant text-charcoal-light/20 text-[13px] sm:text-[15px] tracking-[3px] uppercase whitespace-nowrap hover:text-charcoal-light/40 transition-colors duration-500"
                >
                  {name}
                </span>
              ))}
...
function BookingSection() {
  ...
  const inputCls =
    'w-full bg-transparent border-0 border-b border-gold-muted/30 py-3 font-montserrat font-light text-[13px] sm:text-[14px] text-charcoal-light placeholder:text-warm-gray/50 focus:outline-none focus:border-gold transition-colors duration-500';

  return (
    <section
      id="book"
      className="relative py-20 sm:py-28 lg:py-36 overflow-hidden warm-border-top"
      style={{
        background:
          'linear-gradient(180deg, #F0E8D8 0%, #EDE4D4 50%, #F0E8D8 100%)',
      }}
    >
      ...
      <div className="relative z-10 max-w-[580px] mx-auto px-6 text-center">
        ...
        <FadeUp delay={300}>
          <form onSubmit={handleSubmit} className="space-y-7 text-left">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-7">
              <div>
                <label className="block font-montserrat text-[10px] tracking-[2px] uppercase text-gold-muted/70 mb-2">
                  Check-in
                </label>
                <input
                  type="date"
        ...
        <FadeUp delay={500}>
          <div className="mt-12 pt-8">
            <MoroccanDivider />
            <p className="font-montserrat font-light text-brown/60 text-[12px] mt-6 mb-3">
              Or contact us directly
            </p>
            <div className="flex items-center justify-center gap-5 flex-wrap">
              <a
                href="mailto:reservations@thesevensaints.com"
                className="font-montserrat text-[11px] sm:text-[12px] tracking-[1px] text-gold-muted hover:text-gold transition-colors duration-400"
              >
          ...
          <div className="w-full lg:w-[42%] text-center lg:text-left">
            ...
            <FadeUp delay={400}>
              <div className="space-y-5 font-montserrat font-light text-cream/55 text-[13px] leading-[1.9]">
                <div>
                  <span className="text-gold-muted/60 text-[10px] tracking-[3px] uppercase block mb-1">
                    From Marrakech
                  </span>
                  Private transfer arranged upon booking. 40-minute scenic
                  drive through the Agafay plateau.
                </div>
                <div>
                  <span className="text-gold-muted/60 text-[10px] tracking-[3px] uppercase block mb-1">
                    From Airport
                  </span>
                  Marrakech Menara Airport (RAK) &mdash; 50-minute private
                  transfer included with all stays.
                </div>
                <div>
                  <span className="text-gold-muted/60 text-[10px] tracking-[3px] uppercase block mb-1">
                    Coordinates
                  </span>
                  31.4&deg;N, 8.2&deg;W &mdash; Summit of the Agafay Stone
                  Dunes
                </div>
              </div>
            </FadeUp>
    ...
    <footer className="bg-charcoal py-16 sm:py-24 border-t border-gold/8">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        <div className="text-center mb-14">
          <Logo className="h-10 sm:h-12 mb-4 opacity-50" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 text-center mb-14">
          <div>
            <h4 className="font-montserrat text-[10px] tracking-[3px] uppercase text-gold-muted/40 mb-5">
              Contact
            </h4>
            <div className="space-y-2.5">
              <a
                href="mailto:reservations@thesevensaints.com"
                className="block font-montserrat font-light text-cream/40 text-[12px] hover:text-gold transition-colors duration-400"
              >
                reservations@thesevensaints.com
              </a>
              <a
          ...
          <div>
            ...
            <div className="flex items-center justify-center gap-5">
              <a
                href="#"
                className="text-cream/35 hover:text-gold transition-colors duration-400"
        ...
        <div className="max-w-[380px] mx-auto text-center mb-12">
          <p className="font-montserrat text-[9px] tracking-[3px] uppercase text-gold-muted/35 mb-3">
            Newsletter
          </p>
          <form onSubmit={handleSub} className="flex items-end gap-3">
            <input
              ...
              className="flex-1 bg-transparent border-0 border-b border-gold/15 py-2 font-montserrat font-light text-[12px] text-cream/60 placeholder:text-cream/20 focus:outline-none focus:border-gold/40 transition-colors duration-500"
              required
            />
            <button
              type="submit"
              className="font-montserrat text-[10px] tracking-[2px] uppercase text-gold-muted/40 hover:text-gold transition-colors duration-400 pb-2"
            >
              {subscribed ? '\u2713' : '\u2192'}
            </button>
          </form>
        ...
        >
          ...
          <p className="font-montserrat font-light text-warm-gray/18 text-[9px] tracking-[1px] mt-2">
            &copy; {new Date().getFullYear()} The Seven Saints. All rights
            reserved.
          </p>
        </div>
      </div>
